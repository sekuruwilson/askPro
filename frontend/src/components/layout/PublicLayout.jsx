  ...
  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      >
            ...
            <div className="p-2 border-t border-navy-800">
              <Link
                ...
                className="flex items-center gap-2 px-3 py-2 rounded-lg text-xs
                           text-slate-500 hover:bg-navy-800 hover:text-slate-300 transition-colors"
              >
        ...
        {/* Collapsed: admin icon at bottom */}
        {collapsed && (
          <div className="mt-auto p-2 border-t border-navy-800">
            <Link
              to="/admin/dashboard"
              className="w-9 h-9 flex items-center justify-center rounded-lg mx-auto
                         text-slate-500 hover:text-white hover:bg-navy-700 transition-colors"
              title="Admin Panel"
            >
